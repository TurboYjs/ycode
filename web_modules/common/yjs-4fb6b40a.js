import { u as unexpectedCase, m as methodUnimplemented, c as create$4 } from './error-255dce3a.js';
import { y as map, z as nop, A as getVariable, B as isNode, g as getUnixTime, C as create$2, O as Observable, s as setIfUndefined, D as from, r as readVarUint, d as createDecoder, w as writeVarUint, u as writeUint8, a as writeVarString, b as readVarString, f as floor, E as last, F as equalFlat, G as BIT2, H as BIT4, I as BIT1, J as BIT3, K as BITS5, L as BIT8, M as BIT7, N as BIT6, P as appendTo, x as readUint8, Q as IntDiffOptRleDecoder, n as readVarUint8Array, U as UintOptRleDecoder, R as RleDecoder, S as StringDecoder, p as readAny, T as Encoder, t as toUint8Array, V as IntDiffOptRleEncoder, W as UintOptRleEncoder, X as RleEncoder, Y as StringEncoder, k as writeVarUint8Array, Z as writeUint8Array, q as writeAny, _ as create$3, m as min, $ as callAll, a0 as max, a1 as copy, a2 as copyUint8Array, c as createEncoder, a3 as any, a4 as abs } from './function-f1ec623e.js';
...
const typeListDelete = (transaction, parent, index, length) => {
  ...
  if (length > 0) {
    throw create$4('array length exceeded')
  }
  if (parent._searchMarker) {
...
class Item extends AbstractStruct {
  ...
  delete (transaction) {
    if (!this.deleted) {
      ...
      setIfUndefined(transaction.changed, parent, create$3).add(this.parentSub);
...
export { decodeSnapshot as $, AbstractConnector as A, BOLD as B, ContentAny as C, Doc as D, YEvent as E, YMapEvent as F, GREY as G, YTextEvent as H, ID as I, YXmlEvent as J, applyUpdateV2 as K, compareIDs as L, compareRelativePositions as M, createAbsolutePositionFromRelativePosition as N, createDeleteSet as O, PermanentUserData as P, createDeleteSetFromStructStore as Q, RelativePosition as R, Snapshot as S, Transaction as T, UNBOLD as U, createDocFromSnapshot as V, createID as W, createRelativePositionFromJSON as X, YArray as Y, createRelativePositionFromTypeIndex as Z, createSnapshot as _, encodeStateAsUpdate as a, decodeSnapshotV2 as a0, decodeStateVector as a1, decodeStateVectorV2 as a2, emptySnapshot as a3, encodeSnapshot as a4, encodeSnapshotV2 as a5, encodeStateAsUpdateV2 as a6, encodeStateVectorV2 as a7, equalSnapshots as a8, findRootTypeKey as a9, getState as aa, getTypeChildren as ab, isDeleted as ac, isParentOf as ad, iterateDeletedStructs as ae, logType as af, readRelativePosition as ag, readUpdate as ah, readUpdateV2 as ai, snapshot as aj, transact as ak, tryGc as al, typeListToArraySnapshot as am, typeMapGetSnapshot as an, writeRelativePosition as ao, applyUpdate as b, createModuleLogger as c, UNCOLOR as d, encodeStateVector as e, AbstractStruct as f, AbstractType as g, ContentBinary as h, ContentDeleted as i, ContentEmbed as j, ContentFormat as k, ContentJSON as l, ContentString as m, ContentType as n, GC as o, Item as p, YMap as q, rand as r, YText as s, UndoManager as t, uuidv4 as u, YXmlElement as v, YXmlFragment as w, YXmlHook as x, YXmlText as y, YArrayEvent as z };
